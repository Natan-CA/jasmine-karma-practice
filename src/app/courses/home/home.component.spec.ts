...
fdescribe("HomeComponent", () => {
    ...
    beforeEach(waitForAsync(() => {
        ...
        TestBed.configureTestingModule({
            imports: [
                CoursesModule,
                /* componente usa animações então é necessario esse import para não quebrar ele */
    ...
    /* fila de execução de tarefas são 3 os testes|microtasks(promisses)|macrotasks(setTimout, delay) */
